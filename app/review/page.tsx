...
export default function ReviewPage() {
  return (
    <AppShell>
      <PageHeader eyebrow="Phase 4 Review" title="Spaced Repetition & Flashcards" description="Daily review queue, easy/good/hard/again actions, favorite decks and next review preview." />

      <div className="mb-6 grid gap-4 md:grid-cols-4">
        <Card className="p-5"><p className="text-sm text-muted-foreground">Due today</p><p className="mt-2 text-3xl font-black">{vocabularyStats.dueToday}</p></Card>
        <Card className="p-5"><p className="text-sm text-muted-foreground">Mastered</p><p className="mt-2 text-3xl font-black">{vocabularyStats.mastered}</p></Card>
        <Card className="p-5"><p className="text-sm text-muted-foreground">Favorites</p><p className="mt-2 text-3xl font-black">{vocabularyStats.favorites}</p></Card>
        <Card className="p-5"><p className="text-sm text-muted-foreground">Queue</p><p className="mt-2 text-3xl font-black text-cyan-300">{queue.length}</p></Card>
      </div>
      ...
      <div className="grid gap-6 xl:grid-cols-[0.9fr_1.1fr]">
        <Card className="p-6 text-center">
          ...
          <p className="mt-5 text-sm text-muted-foreground">Flashcard front</p>
        ...
        <div className="space-y-4">
          ...
          <Card className="p-5">
            <div className="mb-4 flex items-center justify-between"><h3 className="text-xl font-black">Review queue</h3><Button size="sm" variant="glass"><RotateCcw className="size-4" /> Refresh</Button></div>
